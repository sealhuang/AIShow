...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButton_camera = QtWidgets.QPushButton(Form)
        self.pushButton_camera.setGeometry(QtCore.QRect(10, 10, 97, 27))
        ...
        self.pushButton.clicked.connect(Form.capture)
        ...
        self.pushButton_camera.clicked.connect(
            Form.record_video.start_recording)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButton_camera.setText(_translate("Form", "Start"))
